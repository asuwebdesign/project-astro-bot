...
export function Navigation() {
  ...
  const navHeadingDefaultClasses = 'flex items-center justify-between w-full rounded-full hover:bg-gray-200'
  const navHeadingActiveClasses = 'flex items-center justify-between w-full rounded-full hover:bg-gray-800'
